...
public class DownloadTripStatisticsSoakBinReport extends HttpServlet {

	private static final long serialVersionUID = 3019963294878178516L;
	static final Logger logger = Logger.getLogger(DownloadTripStatisticsSoakBinReport.class);
	...
	throws ServletException, IOException
	{
		...
		String csvFileName = "trip-statistics-soakbin-" + ts + ".csv";
		resp.setHeader("Content-disposition", "attachment;filename="+csvFileName);
		
		try {
			
			String data = api.downloadTripStatisticsSoakBinReport();
