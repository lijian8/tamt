...
public class DownloadSpeedBinSpeedDistributionReport extends HttpServlet {

	private static final long serialVersionUID = 3019963294878178516L;
	static final Logger logger = Logger.getLogger(DownloadSpeedBinSpeedDistributionReport.class);
	
	private SpeedDistributionReportDAO api = new SpeedDistributionReportDAO();
	...
	throws ServletException, IOException
	{
		...
		String csvFileName = "speedbin-distribution-" + ts + ".csv";
		...
		if( tagId != null)
		{
			...
			try {
				...
				String data = api.downloadSpeedDistributionReport(tagId);
			...
			try {
				...
				String data = api.downloadSpeedDistributionReportForRegion();
				resp.getOutputStream().print(data);
