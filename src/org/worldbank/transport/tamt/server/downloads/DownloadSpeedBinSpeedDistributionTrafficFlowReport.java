...
public class DownloadSpeedBinSpeedDistributionTrafficFlowReport extends HttpServlet {

	private static final long serialVersionUID = -6885139517766298655L;
	static final Logger logger = Logger.getLogger(DownloadSpeedBinSpeedDistributionTrafficFlowReport.class);
	...
	throws ServletException, IOException
	{
		...
		String csvFileName = "speed-distribution-traffic-flow" + ts + ".csv";
		...
		if( tagId != null)
		{
			...
			try {
				...
				String data = api.downloadSpeedDistributionTrafficFlowReport(tagId);
			...
			try {
				...
				String data = api.downloadSpeedDistributionTrafficFlowReportForRegion();
				resp.getOutputStream().print(data);
