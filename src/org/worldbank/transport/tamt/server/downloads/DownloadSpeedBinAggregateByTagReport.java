...
public class DownloadSpeedBinAggregateByTagReport extends HttpServlet {

	private static final long serialVersionUID = 5113920167592842926L;
	static final Logger logger = Logger.getLogger(DownloadSpeedBinAggregateByTagReport.class);
	...
	throws ServletException, IOException
	{
		...
		String csvFileName = "speeddistribution-aggregatebytag-" + ts + ".csv";
		resp.setHeader("Content-disposition", "attachment;filename="+csvFileName);
		
		try {
			
			String data = api.downloadSpeedBinAggregateByTagReport();
