	...
	public SpeedDistributionTrafficFlowReport getSpeedDistributionTrafficFlowReport(
		...
		try {
			...
			while (r.next()) {
				...
				<g:Label styleName="{style.cellHeaderIntegerTop}">Vehicle (s)/d</g:Label>
				<g:Label styleName="{style.cellHeaderDoubleTop}">Vehicle (m)/d</g:Label>
				<g:Label styleName="{style.cellHeaderDoubleTop}">Average m/s</g:Label>
				<g:Label styleName="{style.cellHeaderDoubleTop}">% Vehicle (s)/d</g:Label>
				<g:Label styleName="{style.cellHeaderDoubleTop}">% Vehicle (m)/d</g:Label>
				 */
				// skip first two columns (oid, tagid)
